...
# Filename mask used
filename_mask = 'echo_request-noipid'
...
GROUP_COLS = ["ip_src", "icmp_type", "icmp_code", "payload_hex", "IBR_info"]
...
def build_reason(group_row: pd.Series) -> str:
    ...
    return "ip_src;icmp_type;icmp_code;payload_hex;IBR_info"
...
def build_agg_record(group: pd.DataFrame, first_filename: str) -> dict:
    ...
    info = {
        ...
        "payload_hex": str(sample["payload_hex"]),
